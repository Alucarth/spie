...
@section('content')
        ...
        <div class="col-md-2">
            <div class="card card-widget widget-user-2">
                ...
                <div class="widget-user-header bg-info">
                    ...
                    <div class="row">
                        <span>  <strong>Resultado {{ $padre->codigo}}</strong> {{ $padre->descripcion }}</span>
                    </div>
                </div>
                            ...
                            <table id="lista" class="table table-responsive table-bordered table-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{url('planes/pdes/indicadores/'.$item->id)}}"><i class="material-icons text-warning">folder</i></a>
    ...
    {{-- aqui los modals --}}
<pdes-form-component url='{{url('pdes/acciones')}}' csrf='{!! csrf_field('POST') !!}' padre='{{ $padre->id }}'></pdes-form-component>
