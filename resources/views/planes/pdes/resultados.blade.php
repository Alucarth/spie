...
@section('content')
        ...
        <div class="col-md-2">
            <div class="card card-widget widget-user-2">
                ...
                <div class="widget-user-header bg-info">
                    ...
                    <div class="row">
                        <span>  <strong>Meta {{ $padre->codigo}}</strong> {{ $padre->descripcion }}</span>
                    </div>
                </div>
    ...
    {{-- aqui los modals --}}
<pdes-form-component url='{{url('pdes/resultados')}}' csrf='{!! csrf_field('POST') !!}'  padre='{{ $padre->id }}' ></pdes-form-component>
