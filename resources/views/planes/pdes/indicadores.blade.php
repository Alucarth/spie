...
@section('content')
        ...
        <div class="col-md-2">
            <div class="card card-widget widget-user-2">
                ...
                <div class="widget-user-header bg-info">
                    ...
                    <div class="row">
                        <span>  <strong>Accion {{ $padre->codigo}}</strong> {{ $padre->descripcion }}</span>
                    </div>
                </div>
                            ...
                            <table id="lista" class="table table-responsive table-bordered table-hover" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col-5">Indicador</th>                                        
                                        <th scope="col-5">Linea Base</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$item->linea_base_valor}}</td>
                                        <td>
                                            {{-- <a href="{{url('planes/pdes/acciones/'.$item->id)}}"><i class="material-icons text-warning">folder</i></a> --}}
    ...
    {{-- aqui los modals --}}
<indicador-form-component url='{{url('pdes/indicadores')}}' csrf='{!! csrf_field('POST') !!}'  padre='{{ $padre->id }}' ></indicador-form-component>
